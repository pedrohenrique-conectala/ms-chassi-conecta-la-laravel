...
if (!function_exists('redirect')) {
     ...
     * @param array $headers
     * @param bool $secure
     * @return \Illuminate\Support\Facades\Redirect|\Illuminate\Http\RedirectResponse
     */
...
if (!function_exists('str_slug')) {
     ...
     * @return string
     */
    function str_slug(string $string, string $separator = '-', string $locale = null): string
    {
        return (new \Symfony\Component\String\Slugger\AsciiSlugger())->slug($string, $separator, $locale)->lower()->toString();
    }
}
...
if (!function_exists('str_singular')) {
     ...
     * @return string
     */
    function str_singular(string $string): string
    {
        return current((new \Symfony\Component\String\Inflector\EnglishInflector())->singularize($string)) ?: $string;
    }
}
